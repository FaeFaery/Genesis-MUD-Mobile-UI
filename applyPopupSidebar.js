...
function initChatPopup() {
    ...
    if (unreadStartIndex > 0) {
        ...
        if (firstUnreadMessage) {
            ...
            divider.onclick = function(e) { e.target.remove(); };
...
function initializeEventListeners() {
    ...
    mapCanvas.addEventListener("touchstart", handlePointerDown, { passive: true });
    mapCanvas.addEventListener("touchend", handlePointerUp);
    mapCanvas.addEventListener("touchmove", handlePointerMove, { passive: true });
