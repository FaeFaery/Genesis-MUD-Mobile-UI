function initMapExtension() {
    ...
    function injectMinifiedCSS() {
        try {
            ...
            style.textContent = '#mudScrollThumb::after{content: "";position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);width: calc(100% + 20px);height: calc(100% + 20px);z-index: -1;}#magicmap-canvas{display:relative;text-rendering:optimizeLegibility;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;background:#000;width:100%;height:100%;opacity:.9}#magicmap-img{object-fit:cover}#popup-buttons{position:absolute;user-select:none;top:6px;right:0;z-index:1;display:flex;flex-direction:column;background-color:rgba(0,0,0,.3)}#popupnav-container{position:absolute;user-select:none;top:0;right:0;display:flex;padding:10px;flex-direction:row;gap:5px;display:none}#popupnav-container .map-icon, #popupnav-container .chat-icon-container{margin-right:5px}#mobile-nav{position:absolute;top:100px;left:100px;display:flex;flex-direction:column}.popup-map{width:300px;height:300px;position:relative;border:1px solid #fff;background:#000;opacity:.9}.popup-chat{width:300px;height:100px;position:relative;overflow:hidden;border:1px solid #fff;background-color:rgba(0,0,0,.9)}.chat-content{position:relative;height:calc(100% - 10px);width:100%;color:#d0d0d0;font-family:Source Code Pro,sans-serif;overflow-y:scroll;overflow-x:hidden;word-wrap:break-word;white-space:normal;overflow-wrap:break-word;font-size:14px;padding-right:10px;padding-left:10px;padding-top:10px;box-sizing:content-box}.resizable .resizers{width:100%;height:100%;box-sizing:border-box}.resizable .resizers .resizer{width:30px;height:30px;border-radius:50%;position:absolute}.resizable .resizers .resizer.top-left{left:-15px;top:-15px;cursor:nwse-resize}.resizable .resizers .resizer.top-right{right:-15px;top:-15px;cursor:nesw-resize}.resizable .resizers .resizer.bottom-left{left:-15px;bottom:-15px;cursor:nesw-resize}.resizable .resizers .resizer.bottom-right{right:-15px;bottom:-15px;cursor:nwse-resize}.exit-icon{cursor:pointer;user-select:none;width:30px;height:30px;color:#fff;font-size:30px;margin-bottom:-3px;font-variation-settings:\'FILL\' 0,\'wght\' 400,\'GRAD\' 0,\'opsz\' 24}.map-icon{cursor:pointer;display:block;user-select:none;color:#fff;font-size:20px;font-variation-settings:\'FILL\' 1,\'wght\' 300,\'GRAD\' 0,\'opsz\' 24}.center-icon{cursor:pointer;width:30px;height:30px;color:#fff;font-size:30px;user-select:none;font-variation-settings:\'FILL\' 0,\'wght\' 350,\'GRAD\' 0,\'opsz\' 24}.chat-icon{cursor:pointer;user-select:none;width:30px;height:30px;color:#fff;font-size:30px;font-variation-settings:\'FILL\' 1,\'wght\' 250,\'GRAD\' 0,\'opsz\' 24}.swipe-icon{cursor:pointer;user-select:none;margin-left:-5px;width:30px;height:30px;color:#5CE65C;font-size:30px;font-variation-settings:\'FILL\' 1,\'wght\' 250,\'GRAD\' 0,\'opsz\' 24}.zoom-icon {cursor:pointer;width:30px;height:30px;color:#fff;font-size:30px;user-select:none;font-variation-settings: \'FILL\' 0, \'wght\' 250, \'GRAD\' 0, \'opsz\' 24}.settings-icon{cursor:pointer;color:#999999;font-size:30px;margin-right:3px;user-select:none;font-variation-settings: \'FILL\' 1, \'wght\' 250, \'GRAD\' 0, \'opsz\' 24}.chat-icon-container{position:relative;display:inline-block}.chat-badge{font-family:Source Code Pro,sans-serif;position:absolute;top:-5px;right:2px;background-color:red;color:#fff;border-radius:50%;width:15px;height:15px;display:flex;align-items:center;justify-content:center;font-size:9px;font-weight:700;padding:0;line-height:1;box-sizing:border-box;text-align:center}.new-message-divider{position:relative;padding-left:0;padding-right:0;box-sizing:border-box;display:flex;justify-content:center;align-items:center;padding-top:5px;width:calc(100% - 20px);margin-left:0;margin-right:0;font-size:8px;font-weight:bold;text-transform:uppercase;color:white;font-family:Arial,sans-serif;user-select:none;}.new-message-divider>span{padding:4px 10px;background-color:#ff2d2d;border-radius:8px}#scroll-to-bottom{position:absolute;bottom:0;right:50%;padding:5px 10px;background:rgba(0,0,0,.5);color:#fff;border:none;border-radius:50%;cursor:pointer;-webkit-box-shadow:none;animation:bobbing 1s ease-in-out infinite}@keyframes bobbing{0%,100%{transform:translateY(0)}50%{transform:translateY(-5px)}}.zoom-controls{user-select:none;display:none;z-index:1;flex-direction:column;align-items:center;position:absolute;left:10px;top: 50%;transform: translateY(-50%);padding:5px 1px;background-color:rgba(255,255,255,.1);border-radius:4px}.zoom-slider{width:30px;height:100px;margin:10px 0}.zoom-btn{width:20px;height:20px;color:rgba(255,255,255);border-radius:4px;background-color:rgba(245,245,245,.3);cursor:pointer;font-size:16px;display:flex;align-items:center;justify-content:center}.popup-settings{position:absolute;z-index:1;border:1px solid #fff;background:#000;font-family:Source Code Pro,sans-serif;top:50%;left:50%;transform:translate(-50%,50%);font-size:14px;color:#d0d0d0;height:fit-content;width:340px;padding:10px;box-sizing:border-box;display:none;flex-direction:column;justify-content:space-between;user-select:none;}.popup-settings .sections-container{flex:1;}.popup-settings .section{margin-bottom:8px;}.popup-settings .section-title{user-select:none;font-weight:bold;border-bottom:1px solid #444;padding-bottom:2px;margin-bottom:4px;color:#fff;font-size:13px;}.popup-settings .input-rows{display:flex;flex-wrap:wrap;margin:0 -3px;}.popup-settings .input-group{width:50%;padding:0 3px;box-sizing:border-box;margin-bottom:4px;}.popup-settings label{user-select:none;display:block;margin-bottom:2px;font-size:11px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.popup-settings input{width:100%;background:#222;border:1px solid #444;color:#d0d0d0;padding:2px 4px;font-family:Source Code Pro,sans-serif;font-size:11px;outline:none;box-sizing:border-box;height:22px;}.popup-settings input:focus{border-color:#666;}.popup-settings .button-row{user-select:none;display:flex;justify-content:space-between;padding-top:5px;border-top:1px solid #333;}.popup-settings .left-buttons,.popup-settings .right-buttons{display:flex;gap:5px;}.popup-settings button{background:#333;border:1px solid #555;color:#d0d0d0;padding:3px 3px;cursor:pointer;font-family:Source Code Pro,sans-serif;font-size:11px;transition:all 0.2s;min-width:48px;touch-action:manipulation;}.popup-settings #cancel-button{background:#8B0000;border-color:#5A002C;}.popup-settings #save-button{background:#006400;border-color:#06402B;}.popup-settings input[type="color"]{height:22px;padding:0;}.popup-settings .invalid {border: 2px solid red;}.popup-settings .error-message {color: red;font-size: 0.5em;margin-top: 5px;}';
        ...
        try {
            ...
            document.fonts.ready.then(() => {
                ...
                document.getElementById("mudoutput").appendChild(Object.assign(document.createElement("div"), {
                    textContent: "Mobile Popups have been loaded!",
    ...
    let settingsControls = {
        ...
        save: function() {
            ...
            $('.popup-settings #cancel-button').click();
