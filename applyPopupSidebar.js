...
function initMapExtension() {
    ...
    window.showChat = function() {
        ...
        if (chatContent.scrollHeight - chatContent.scrollTop <= chatContent.clientHeight + 10) window.addScrollToBottomButton();
