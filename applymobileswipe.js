(() => {
    ...
    function updateScrollbarThumb() {
        ...
        thumb.style.opacity = scrollRatio < 1 ? '0.65' : '0';
    }
    ...
    function onScrollbarTouchStart(e) {
        ...
        const thumb = document.getElementById('mudScrollThumb');
        if (thumb) thumb.style.backgroundColor = 'rgba(0, 0, 0, 0.75)';
    }
    ...
    function onScrollbarTouchEnd(e) {
        ...
        const thumb = document.getElementById('mudScrollThumb');
        if (thumb) thumb.style.backgroundColor = 'rgba(0, 0, 0, 0.65)';
    }
    ...
    // A variable to track the state of the gestures 
    let gesturesOn = true;
